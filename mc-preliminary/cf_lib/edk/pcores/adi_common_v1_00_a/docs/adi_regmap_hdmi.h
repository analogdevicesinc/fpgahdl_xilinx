...
#define EMBEDSYNC_ENB                  (1 << 3)                  /* RW, Controls synchornization signals- HSYNC,
                                                                 VSYNC and DE. If set (0x1) assumes embedded sync. */
#define CrCb_INIT                      (1 << 2)                  /* RW, If set (0x1) CSC uses CbCr order (Cb is
                                                                 driven first after DE rising). */
...
#define SOURCE_SEL(x)                  (((x) & 0x3) << 0)        /* RW, Select the HDMI data source- constant (0x2),
                                                                 incr-pattern (0x1) or input (0x0). */
