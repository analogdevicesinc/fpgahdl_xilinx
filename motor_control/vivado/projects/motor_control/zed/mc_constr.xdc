...
set_property LOC XADC_X0Y0 [get_cells i_system_wrapper/system_i/xadc_wiz_1/inst/AXI_XADC_CORE_I/XADC_INST]

#Necessary to define the pins in release 2013.2. The IOSTANDARD should be a differential standard for zynq devices.
set_property PACKAGE_PIN E16 [get_ports vauxn0]
set_property IOSTANDARD TMDS_33 [get_ports vauxn0]
set_property PACKAGE_PIN D17 [get_ports vauxn8]
set_property IOSTANDARD TMDS_33 [get_ports vauxn8]
set_property PACKAGE_PIN F16 [get_ports vauxp0]
set_property IOSTANDARD TMDS_33 [get_ports vauxp0]
set_property PACKAGE_PIN D16 [get_ports vauxp8]
set_property IOSTANDARD TMDS_33 [get_ports vauxp8]
set_property PACKAGE_PIN M12 [get_ports vn_in]
set_property IOSTANDARD LVDS [get_ports vn_in]
set_property PACKAGE_PIN L11 [get_ports vp_in]
set_property IOSTANDARD LVDS [get_ports vp_in]
